    ...
    public static AccountCreationWebviewHelper getInstance() {
        if(instance == null) {
            if(Compatibility.isCompatible(8)) {
                instance = new com.voiceblue.phone.wizards.utils.AccountCreationWebviewHelper8();
            }else {
                instance = new com.voiceblue.phone.wizards.utils.AccountCreationWebviewHelper3();
            }
        }
