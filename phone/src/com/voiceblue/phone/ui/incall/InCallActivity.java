...
package com.voiceblue.phone.ui.incall;
...
import com.voiceblue.phone.ui.incall.DtmfDialogFragment.OnDtmfListener;
import com.voiceblue.phone.ui.incall.locker.IOnLeftRightChoice;
import com.voiceblue.phone.ui.incall.locker.InCallAnswerControls;
import com.voiceblue.phone.ui.incall.locker.ScreenLocker;
import com.voiceblue.phone.utils.CallsUtils;
...
import com.voiceblue.phone.utils.keyguard.KeyguardWrapper;
...
public class InCallActivity extends SherlockFragmentActivity implements IOnCallActionTrigger, 
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        wakeLock = powerManager.newWakeLock(PowerManager.SCREEN_BRIGHT_WAKE_LOCK
                ...
                "com.voiceblue.phone.onIncomingCall");
    ...
    private void attachVideoPreview() {
        ...
        if(prefsWrapper.getPreferenceBooleanValue(SipConfigManager.USE_VIDEO)) {
            ...
            if(videoWakeLock == null) {
                videoWakeLock = powerManager.newWakeLock(PowerManager.SCREEN_BRIGHT_WAKE_LOCK | PowerManager.ACQUIRE_CAUSES_WAKEUP, "com.voiceblue.phone.videoCall");
