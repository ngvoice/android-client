...
import com.voiceblue.phone.utils.Ringer;
import com.voiceblue.phone.utils.accessibility.AccessibilityWrapper;
import com.voiceblue.phone.utils.audio.AudioFocusWrapper;
import com.voiceblue.phone.utils.bluetooth.BluetoothWrapper;
import com.voiceblue.phone.utils.bluetooth.BluetoothWrapper.BluetoothChangeListener;
		...
		*/
		...
		if(wifiLock == null) {
			wifiLock = wman.createWifiLock( 
							...
							"com.voiceblue.phone.InCallLock");
		...
		if(winfo != null) {
			...
			if(service.getPrefs().getPreferenceBooleanValue(SipConfigManager.KEEP_AWAKE_IN_CALL)) {
				if(screenLock == null) {
		            ...
		            screenLock = pm.newWakeLock(PowerManager.SCREEN_DIM_WAKE_LOCK | PowerManager.ON_AFTER_RELEASE, "com.voiceblue.phone.onIncomingCall.SCREEN");
