...
package com.voiceblue.phone.service;
...
import com.voiceblue.phone.api.ISipConfiguration;
...
import com.voiceblue.phone.pjsip.PjSipCalls;
import com.voiceblue.phone.pjsip.PjSipService;
import com.voiceblue.phone.pjsip.UAStateReceiver;
import com.voiceblue.phone.service.receiver.DynamicReceiver4;
import com.voiceblue.phone.service.receiver.DynamicReceiver5;
import com.voiceblue.phone.ui.incall.InCallMediaControl;
...
//		connectivityManager = (ConnectivityManager) getSystemService(Context.CONNECTIVITY_SERVICE);
	...
	private void applyComponentEnablingState(boolean active) {
        ...
        ComponentName cmp = new ComponentName(this, "com.voiceblue.phone.ui.PrivilegedOutgoingCallBroadcaster");
        try {
...
//        presenceMgr.startMonitoring(this);
	...
	private synchronized void acquireResources() {
		...
		if (prefsWrapper.getPreferenceBooleanValue(SipConfigManager.USE_PARTIAL_WAKE_LOCK)) {
			...
			if (wakeLock == null) {
				wakeLock = pman.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "com.voiceblue.phone.SipService");
		...
		if (wifiLock == null) {
			...
			wifiLock = wman.createWifiLock(mode, "com.voiceblue.phone.SipService");
