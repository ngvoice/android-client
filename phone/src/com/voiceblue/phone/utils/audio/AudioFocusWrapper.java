...
package com.voiceblue.phone.utils.audio;
	...
	public static AudioFocusWrapper getInstance() {
		if(instance == null) {
			if(Compatibility.isCompatible(8)) {
			    instance = new com.voiceblue.phone.utils.audio.AudioFocus8();
			}else {
			    instance = new com.voiceblue.phone.utils.audio.AudioFocus3();
			}
		}
