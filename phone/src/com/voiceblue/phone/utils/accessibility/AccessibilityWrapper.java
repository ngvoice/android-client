...
package com.voiceblue.phone.utils.accessibility;
	...
	public static AccessibilityWrapper getInstance() {
		if(instance == null) {
			if(Compatibility.isCompatible(4)) {
			    instance = new com.voiceblue.phone.utils.accessibility.Accessibility4();
			}else {
			    instance = new com.voiceblue.phone.utils.accessibility.Accessibility3();
			}
		}
