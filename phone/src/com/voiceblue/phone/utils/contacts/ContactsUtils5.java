...
public class ContactsUtils5 extends ContactsWrapper {
    ...
    /* (non-Javadoc)
     * @see com.voiceblue.phone.utils.contacts.ContactsWrapper#isExternalPhoneNumber(android.content.Context, android.database.Cursor)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.voiceblue.phone.utils.contacts.ContactsWrapper#bindContactPhoneView(android.view.View, android.content.Context, android.database.Cursor)
     */
    @Override
