...
package com.voiceblue.phone.utils.backup;
	...
	public static BackupWrapper getInstance(Context context) {
		if(instance == null) {
		    if(Compatibility.isCompatible(8)) {
                instance = new com.voiceblue.phone.utils.backup.BackupUtils8();
			}else {
                instance = new com.voiceblue.phone.utils.backup.BackupUtils3();
			}
		    if(instance != null) {
