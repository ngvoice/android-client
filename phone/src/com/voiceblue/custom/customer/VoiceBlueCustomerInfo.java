package com.voiceblue.custom.customer;
...
public class VoiceBlueCustomerInfo {
	...
	public int getFlagResource() {
		...
		else if (mCountry.equals("ES"))
			return R.drawable.ic_flag_spain;
		else if (mCountry.equals("EC"))
			return R.drawable.ic_flag_ecuador;
		else if (mCountry.equals("MX"))
			return R.drawable.ic_flag_mexico;
		else if (mCountry.equals("AR"))
			return R.drawable.ic_flag_argentina;
		else if (mCountry.equals("US"))
			return R.drawable.ic_flag_usa;
		else if (mCountry.equals("BO"))
			return R.drawable.ic_flag_bolivia;
		else if (mCountry.equals("LV"))
			return R.drawable.ic_flag_latvia;
		else if (mCountry.equals("DK"))
			return R.drawable.ic_flag_denmark;
		else if (mCountry.equals("UK") || mCountry.equals("GB"))
